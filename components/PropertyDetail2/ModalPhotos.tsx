    ...
    const renderSlider = () => {
        return (
            ...
            >
                ...
                {/*  */}
                <div className="z-20 flex max-w-6xl mx-auto my-2 transform xl:absolute xl:-inset-x-20 top-full xl:top-1/2 xl:-translate-y-1/2 xl:justify-between    ">
                    <NextPrev
                        onlyPrev
                        className="mr-1.5 "
    ...
    const renderModalPhotos = () => {
        return (
            <Dialog
                ...
                as="div"
                className="fixed inset-0 overflow-y-auto z-50 dark bg-neutral-800 text-neutral-200 hiddenScrollbar"
                onClose={onClose}
                open={isOpen}
            >
