...
const PropertyCardH: FC<PropertyCardHProps> = ({
  ...
  const renderSliderGallery = () => {
    return (
      <div className="flex-shrink-0 w-full p-3 sm:w-64 ">
        <GallerySlider
          ratioClass="aspect-w-1 aspect-h-1"
          galleryImgs={galleryImgs}
          className="w-full h-full overflow-hidden rounded-2xl will-change-transform"
      ...
      <div className="inline-grid grid-cols-3 gap-2">
        <div className="flex items-center space-x-2">
          <span className="hidden sm:inline-block">
            <i className="text-lg las la-bed"></i>
          </span>
        ...
        <div className="flex items-center space-x-2">
          <span className="hidden sm:inline-block">
            <i className="text-lg las la-bath"></i>
          </span>
          <span className="text-xs text-neutral-500 dark:text-neutral-400">
            3 baths
          </span>
        ...
        <div className="flex items-center space-x-2">
          <span className="hidden sm:inline-block">
            <i className="text-lg las la-expand-arrows-alt"></i>
          </span>
          <span className="text-xs text-neutral-500 dark:text-neutral-400">
            1200 Sq. Fit
          </span>
  ...
  const renderContent = () => {
    return (
      <div className="flex flex-col items-start flex-grow p-3 sm:pr-6">
        <div className="w-full space-y-4">
          ...
          <div className="flex items-end justify-between w-full">
            ...
            <span className="flex items-center justify-center px-3 py-2 text-base font-medium leading-none border rounded border-secondary-500 text-secondary-500">
              {`${price},000`}
            </span>
          </div>
        </div>
  ...
  return (
    ...
    >
      <Link
        href={href}
        className="flex flex-col w-full h-full sm:flex-row sm:items-center"
      >
        {renderSliderGallery()}
        {renderContent()}
      </Link>
